# -*- coding: utf-8 -*-
"""
Created on Mon Aug  8 13:19:19 2022
...
def Table_Prep():
    df = pd.read_csv(r'C:\Users\33o\Documents\Python Scripts\data\master_refinery.csv')
...
def Model_Prep(df):
    ...
    df.drop(['year','est','emp'],axis=1,inplace=True)
...
fig.suptitle('Oil Consumption Model')

ax1.scatter(y_p,y_train)
ax1.set_ylabel('predicted oil consumption')
ax1.set_xlabel('true oil consumption')
...
ax2.set_ylabel('predicted oil consumption')
ax2.set_xlabel('true oil consumption')
